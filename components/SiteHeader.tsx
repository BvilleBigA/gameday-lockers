      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4">
        ...
        <nav className="flex flex-wrap items-center gap-3 text-sm">
          {status === "loading" ? (
            ...
            <>
              <Link href="/admin" className="font-medium text-[#3d7d6c] hover:text-[#52A88E]">
                Dashboard
              </Link>
            ...
            <>
              ...
              <Link
                href="/signup"
                className="rounded-md bg-[#52A88E] px-3 py-1.5 font-semibold text-white hover:bg-[#469178]"
              >
                Create account
              </Link>
            </>
